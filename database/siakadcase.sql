...
('3515101', '351510101', 'Desa Bohar Balun'),
...
--
DELIMITER $$
CREATE TRIGGER `delete_khs` AFTER DELETE ON `khs` FOR EACH ROW BEGIN
INSERT INTO log_khs VALUES('',old.NimMhs,old.KodeMk,old.NipDosen,old.TahunAjaran,old.KodeSemester,"DELETE DATA DI KHS",old.NilaiTugas,null,old.NilaiUts,null,old.NilaiUas,null,now());
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update_khs` AFTER UPDATE ON `khs` FOR EACH ROW BEGIN
INSERT INTO log_khs VALUES('',old.NimMhs,old.KodeMk,old.NipDosen,old.TahunAjaran,old.KodeSemester,"UPDATE DATA DI KHS",old.NilaiTugas,new.NilaiTugas,old.NilaiUts,new.NilaiUts,old.NilaiUas,new.NilaiUas,NOW());
END
$$
DELIMITER ;
...
--
-- Table structure for table `log_khs`
--
-- Error reading structure for table siakadcase.log_khs: #1932 - Table 'siakadcase.log_khs' doesn't exist in engine
-- Error reading data for table siakadcase.log_khs: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `siakadcase`.`log_khs`' at line 1
...
('197406102008121002', '1IF001', '20152016', '1', 0.2, 0.3, 0.5),
('197406102008121002', '1IF002', '20152016', '1', 0.2, 0.3, 0.5),
('197406102008121002', '1IF003', '20152016', '1', 0.2, 0.3, 0.5),
('197606102008121011', '1IF004', '20152016', '1', 0.2, 0.3, 5),
('197606102008121011', '1IF005', '20152016', '1', 0.2, 0.3, 5),
('197606102008121011', '2IF001', '20152016', '1', 0.2, 0.3, 5),
('198101092006041003', '2IF002', '20152016', '2', 0.2, 0.3, 5),
('198101092006041003', '2IF003', '20152016', '2', 0.2, 0.3, 5),
('198101092006041003', '2IF004', '20152016', '2', 0.2, 0.3, 5);
...
--
-- Table structure for table `statusmatakuliah`
--
...
--
-- Dumping data for table `statusmatakuliah`
--
